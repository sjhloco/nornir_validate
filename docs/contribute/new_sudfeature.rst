...
.. code-block:: bash
    ...
    ❯ python feature_builder.py -cmd  cisco_viptela sdwan
...
.. code-block:: bash
    ...
    ❯ python feature_builder.py -di cisco_viptela sdwan.omp_peer show_omp_peers.raw
...
.. code-block:: bash
    ...
    ❯ python feature_builder.py -ds cisco_viptela sdwan
