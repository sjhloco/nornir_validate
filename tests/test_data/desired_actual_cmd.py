...
desired_state = {
    ...
    'show ip access-lists TEST_SSH_ACCESS': {'_mode': 'strict',
                                            '10': {'action': 'permit', 'protocol': 'ip', 'src': '10.17.10.0/24', 'dst': 'any'},
                                            '20': {'action': 'permit', 'protocol': 'ip', 'src': '10.10.10.10/32', 'dst': 'any'},
                                            '30': {'action': 'deny', 'protocol': 'ip', 'src': 'any', 'dst': 'any'}},
    'show etherchannel summary': {'Po3': {
                                'status': 'U',
                                'protocol': 'LACP',
                                'members': {'_mode': 'strict',
                                'Gi0/15': {'mbr_status': 'P'},
                                'Gi0/16': {'mbr_status': 'P'}}}}
                }
...
actual_state = {
    ...
    "show ip access-lists TEST_SSH_ACCESS": {"10": {"action": "permit", "dst": "any", "protocol": "ip", "src": "10.17.10.0/24"},
                                             "20": {"action": "permit", "dst": "any", "protocol": "ip", "src": "10.10.10.10/32"},
...
cmd_output = {
    "show ip ospf neighbor": [{"address":"192.168.255.1",
                              ...
                              {"address":"2.2.2.2",
                                ...
                                "priority": "1",
                                "state": "FULL/BDR"}],
    "show ip access-lists TEST_SSH_ACCESS":[{"acl_name": "TEST_SSH_ACCESS",
                                              "line_num": ""},
                                             ...
                                             {"acl_name": "TEST_SSH_ACCESS",
                                              ...
                                              "dst_any":
                                              "any"}],
    "show etherchannel summary": [{"group": "3",
                                "po_name": "Po3",
                                "po_status": "SD",
                                "protocol": "LACP",
